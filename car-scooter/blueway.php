...
<div id="wrapper">
  ...
  <div id="main-container">
   ...
   <div class="left-content">
    ...
    <h5>BLUEWAY CAR RENTAL DRIVING YOUR WORLD </h5>
    ...
    <div id="advertiser">
     ...
     <div class="col2">
      During so many years we have been operated the Budget Car Rental Brand as a sub licensee of the Master franchise in Mexico. We have created a new brand to start our own business in the car rental industry and facing new goals with our existing customers
    </div>
  </div>
  ...
  <div id="advertiser">
    <div class="col4">
      <table class="info-advertiser">
        <tr>
          <td class="campo">Address:</td> <td class="dato">5 av. norte entre calles 2 y 4 local # 8</td>
        </tr>
        <tr>
          <td class="campo">Address 2:</td> <td class="dato">boulevard aeropuerto con esquina 65 av.</td>
        </tr>
        <td class="campo">Phone 1:</td><td class="dato">987 872 0903</td>
        </tr>
        <tr>
