...
<head>
  ...
  <title>Blueway - Safe Map Cozumel</title>
  <!-- Meta tags -->   
...
<div id="wrapper">
  ...
  <div id="main-container">
   ...
   <div class="left-content">
    ...
    <h5>BLUEWAY CAR RENTAL MEJORANDO SU MUNDO</h5>
    ...
    <div id="advertiser">
     ...
     <div class="col2">
      Durante muchos años operamos bajo el nombre de Budget car rental como franquicia en Mexico, mientras creamos nuestra propia marca e identidad en la industria de la renta de autos y enfrentamos asi nuevos rentos para la satisfaccion de nuestros clientes.
    </div>
  </div>
  ...
  <div id="advertiser">
    <div class="col4">
      <table class="info-advertiser">
        <tr>
          <td class="campo">Dirección:</td> <td class="dato">5 av. norte entre calles 2 y 4 local # 8</td>
        </tr>
        <tr>
          <td class="campo">Dirección 2:</td> <td class="dato">boulevard aeropuerto con esquina 65 av.</td>
        </tr>
        <td class="campo">Teléfono 1:</td><td class="dato">987 872 0903</td>
        </tr>
        <tr>
          <td class="campo">Teléfono 2:</td><td class="dato">987 872 5177</td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" class="info-email">
            <a href="http://safemapcozumel.com/car-scooter/blueway/" id="contacto">
              "Send a Email"
  ...
  <div class="col5">
        <a href="https://maps.google.com/maps/ms?msid=203173678386505060299.0004d394fb50ba21cdfe6&msa=0" id="mapaVer">
