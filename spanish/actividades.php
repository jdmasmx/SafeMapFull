    ...
    <div id="main-container">
     ...
     <div class="left-content">
        <div id="info-container">
            ...
            <h3>Alquiler de coches &amp; motocicletas</h3>
            <div class="styled_table table_gray">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
            ...
            <h3>Salud &amp; Servicios de Salud</h3>
            <div class="styled_table table_gray">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
                ...
                <h3>Artesanías, Boutique & Arts</h3>
                <div class="styled_table table_gray">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
            ...
            <h3>Joyería de Plata &amp; Tiendas</h3>
            <div class="styled_table table_gray">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
...
<h3>Finanzas &amp; agente de bienes raíces</h3>
<div class="styled_table table_gray">
    <table width="100%" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
...
<h3>Cozumel Tours y Actividades</h3>
<div class="styled_table table_gray">
