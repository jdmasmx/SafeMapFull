...
<div id="wrapper">
  ...
  <div id="main-container">
   ...
   <div class="left-content">
    ...
    <h5>Coral Princess Hotel &amp; Resort es parte de tu Universo!</h5>
    ...
    <div id="advertiser">
      ...
      <div class="col2">
        Ubicado frente al Arrecife San Juan para deleitarse en las cristalinas aguas del Mar Caribe, conviviendo con maravillosas especies marinas de múltiples formas y colores. Situados a sólo 5 min. del Aeropuerto y a 15 min. caminando desde el pintoresco pueblo de San Miguel.
      </div>
    </div>
    ...
    <div id="advertiser">
     ...
     <div class="col2">
       Ofrece 142 habitaciones para seleccionar vistas a la Jungla o frente al impresionante Mar Turquesa. Ya sea en lindas habitaciones Tipo Studio, o en muy cómodas Suites de una, dos o tres recámaras; todas amuebladas y equipadas para brindar días de relajamiento y felicidad!
    </div>
  </div>
  ...
  <div id="advertiser">
    <div class="col4">
      <table class="info-advertiser">
        <tr>
          <td class="campo">Dirección:</td> <td class="dato">Carretera Costera Norte Km. 2.5</td>
        </tr>
        <tr>
          <td class="campo">dirección 2:</td><td class="dato">Zona Hotelera Norte</td>
        </tr>
        <tr>
          <td class="campo">Teléfono:</td><td class="dato">987 872 3200</td>
        </tr>
        ...
        <tr>
          <td colspan="2" class="info-email">
            <a href="http://safemapcozumel.com/spanish/beach-hotels/coral-princess" id="contacto">
              "Envia un Email"
