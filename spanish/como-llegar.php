               ...
               <ul id="main_menu">
                ...
                <li><a href="informacion.php" >Información</a>
                 <ul>
                    ...
                    <li  class="current"><a href="como-llegar.php">Como Llegar</a></li>
                </ul>
            </li>
    ...
    <div id="main-container">
       ...
       <div class="left-content">
        <div id="info-container">
            ...
            <h3>Transbordador de pasajeros</h3>
            <div class="styled_table table_gray">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <thead>
                        <tr>
