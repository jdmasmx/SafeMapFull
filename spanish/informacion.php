        ...
        <div id="info-container">
            ...
            <div class="blog-img">
                ...
                <table class="mapas">
                    ...
                    <tr>
                        <td>
                          <a href="acerca-cozumel.php"><img class="borde" src="../images/tourist_information/3.jpg" width="164" height="380" alt="About Cozumel" /></a></td>
                          <td><a href="donde-hospedarse.php"><img class="borde" src="../images/tourist_information/1.jpg" width="164" height="380" alt="Where to Stay" /></a></td>
                          <td><a href="actividades.php"><img class="borde" src="../images/tourist_information/2.jpg" width="164" height="380" alt="Things to Do" /></a></td>
                      </tr>
                      <tr>
                        <td colspan="3">
                            <br />
                    ...
                    <tr>
                        <td colspan="3"> <br />
                            <a href="como-llegar.php"><img class="borde" src="../images/tourist_information/4.jpg" width="100%" height="137" alt="How to get to Cozumel" /></a></td>
                        </tr>
                    </table>
                </div>
                <div class="title_styling">
