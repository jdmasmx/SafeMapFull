...
<!-- Activities-->
    <div class="category" id="activities">Activities</div>
    ...
    <!-- End Activities-->
    <!-- Health -->
    <div class="category" id="agency">Agency</div>
    ...
    <ul class="list-category" id="art">
        ...
        <li>
            <a href="http://safemapcozumel.com/beach-hotels/playa-azul.php">* PLAYA AZUL</a>
        </li>
    ...
    <!-- End Health-->
    <!--Restaurants -->
    <div class="category" id="restaurantes">Restaurants</div>
    ...
    <a href="http://www.safemapcozumel.com/images/ediciones/jun%20-%20sep/junio%20-%20septiembre.pdf" target="_blank">
        <img src="http://www.safemapcozumel.com/images/printmap.jpg">
    </a>
    ...
    <div class="contactus">
        <a href="mailto:ventas@safemapcozumel.com">ventas@safemapcozumel.com</a>
        <br /><br />
        <strong>USA & CAN Call Toll Free</strong>
        <br />
        1(855)552-6986<br />
        1(855)55-COZUMEL
        <br /><br />
        <strong>While in Cozumel</strong>
        <br />
        857-0601<br />
    </div>
    <hr class="divide"/>
    <a href="http://www.safemapcozumel.com/issues.php">
        <img src="http://www.safemapcozumel.com/images/mapaagregar.png">
    </a>
    <hr class="divide"/>
    <div class="title_styling">
        <h1>Weather in Cozumel</h1>
        <div class="title_underline"></div>
    </div>
    <div id="cont_4c14c0235d110b2cfb2b5a217d79be56"> <span id="h_4c14c0235d110b2cfb2b5a217d79be56"><a id="a_4c14c0235d110b2cfb2b5a217d79be56" href="http://www.yourweather.co.uk/" target="_blank" style="color:#656565;font-family:1;font-size:14px;"></a></span></div>
