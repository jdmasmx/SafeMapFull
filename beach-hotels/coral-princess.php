...
<head>
  ...
  <title>Coral Princess Hotel &amp; Resort - Safe Map Cozumel</title>
  <!-- Meta tags -->   
  ...
  <div id="main-container">
   ...
   <div class="left-content">
    ...
    <div class="title_styling">
      <h2>Coral Princess Hotel &amp; Resort</h2>
     
    </div>
    <h5>Coral Princess Hotel &amp; Resort is part of your Universe!</h5>

    <div id="advertiser">
      <div class="col1">
       <a href="http://www.coralprincess.com" target="_blank"><img src="http://safemapcozumel.com/images/anunciantes/coralprincess/logo.jpg"></a>
      </div>
      <div class="col2">
        Coral Princess Hotel &amp; Resort is an oceanfront resort located in front of the San Juan Reef on the North side of Cozumel Island, 5 minutes away from the Airport by car, just 15 minutes walking distance away from the typical Mexican and beautiful San Miguel Town.
      </div>
    </div>

    <div id="advertiser">
      <div class="col1">
        <a href="http://safemapcozumel.com/images/anunciantes/coralprincess/banner-en.png" id="banner">
         <img src="http://safemapcozumel.com/images/anunciantes/coralprincess/banner-en.png" width="270">
       </a>
     </div>
     <div class="col2">
       Offering 142 luxury rooms, standard and suites with one, two or three bedrooms, fully furnished with all the comfort that you deserve.
    </div>
  </div>
  ...
  <div id="advertiser">
    <div class="col4">
      <table class="info-advertiser">
        <tr>
          <td class="campo">Address:</td> <td class="dato">Carretera Costera Norte Km. 2.5</td>
        </tr>
        <tr>
          <td class="campo">Address 2:</td><td class="dato">Zona Hotelera Norte</td>
        </tr>
        <tr>
          <td class="campo">Phone 1:</td><td class="dato">987 872 3200</td>
        </tr>
        
        <tr>
          <td class="campo">Website:</td><td class="dato"><a href="http://www.coralprincess.com" target="_blank"> www.coralprincess.com</a></td>
        </tr>
        
        <tr>
          <td colspan="2" class="info-email">
            <a href="http://safemapcozumel.com/beach-hotels/coral-princess" id="contacto">
              "Send a Email"
   ...
   <!-- <div class="col5">
        <a href="https://maps.google.com/maps/ms?msid=215312241564867698152.0004c4057408a8407034f&msa=0&ll=20.508656,-86.951916&spn=0.001261,0.002637" id="mapaVer">
