...
<div id="wrapper">
  ...
  <div id="main-container">
   ...
   <div class="left-content">
    ...
    <h5>Come and live the experience to be hosted by people who care!!</h5>
    ...
    <div id="advertiser">
      ...
      <div class="col2">
        Playa Azul Cozumel Hotel is the only hotel in Cozumel who gives complimentary Golf to all our guests; Cozumel Country Club is one of the best golf courses on the Yucatan Peninsula, designed by the Nicklaus group.
      </div>
    </div>
    ...
    <div id="advertiser">
     ...
     <div class="col2">
       Our hotel is the perfect choice for your Cozumel wedding celebration, anniversary, honeymoon, or a great vacation with the family. All our Cozumel hotel rooms are Ocean View with a nice balcony terrace where you can watch a breathtaking sunset everyday.
    </div>
  </div>
  ...
  <div id="advertiser">
    <div class="col4">
      <table class="info-advertiser">
        <tr>
          <td class="campo">Address:</td> <td class="dato">Carretera a San Juan Km 4</td>
        </tr>
        <tr>
          <td class="campo">Address 2:</td><td class="dato">Zona Hotelera Norte</td>
        </tr>
        <tr>
          <td class="campo">Phone 1:</td><td class="dato">(987) 869 5160</td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="campo">Website:</td><td class="dato"><a href="http://www.playa-azul.com" target="_blank">www.playa-azul.com</a></td>
        </tr>
        
        <tr>
          <td colspan="2" class="info-email">
            <a href="http://safemapcozumel.com/beach-hotels/playa-azul/" id="contacto">
              "Send a Email"
