...
<div id="wrapper">
  ...
  <div id="main-container">
   ...
   <div class="left-content">
    ...
    <h5>Cozumels´ traditional beach club</h5>
    ...
    <div id="advertiser">
      ...
      <div class="col2">
        Come to Cozumels' traditional beach club. Where you will enjoy snorkel, great seafood, the best cocktails and most important a calm family oriented environment.
 We have free Wi-fi, beach chairs with umbrellas, a suntanning deck, showers, clean bathrooms, beach volley, kids playground and a beautiful Palapa restaurant.
 Come and enjoy Cozumel!!!
      </div>
    </div>
  ...
  <div id="advertiser">
    <div class="col4">
      <table class="info-advertiser">
        <tr>
          <td class="campo">Address:</td> <td class="dato">Carretera a San Juan Km 4.5</td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="campo">Phone 2:</td><td class="dato">(987) 869 5170</td>
        </tr>
        <tr>
